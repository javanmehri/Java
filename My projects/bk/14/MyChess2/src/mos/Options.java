...
public class Options {
    ...
    {
        Report.open_report(3, "cancel_allHighlights(Event)");
...
/*        Game game = GameManager.getTheGame();
        ...
        cancel_highlightCheck();
        cancel_highlightChecker();
        // -----------------------------------------------------------------------------
    ...
    public static void highlightCheck(){
        ...
        Report.open_report(4, "highlightCheck()");
    ...
    public static void cancel_highlightCheck()
    {
        Report.open_report(4, "cancel_highlightCheck()");

        Game game = GameManager.getTheGame();
        Spot kingSpot = game.getUnactivePlayer().getSpotOfKing();
        ImageView imageView = Utl.getImageViewOfSpot(kingSpot);
        imageView.setEffect(null);
    ...
    private static void cancel_highlightChecker()
    {
        if (GameManager.getTheGame()!=null && GameManager.getTheGame().checker!=null)
            Utl.getImageViewOfSpot(GameManager.getTheGame().checker.getSpot()).setEffect(null);
    }
