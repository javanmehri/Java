...
public class Game {
    ...
    public boolean move(Player player, int from_i, int from_j, int to_i, int to_j) throws IOException {
        ...
        {
                if (isValidMove(from_i, from_j, to_i,to_j) && !isAnyPieceOnTheWay(from_i,from_j,to_i,to_j))
                {
        ...
        {
                if (isValidRemove(from_i, from_j, to_i,to_j) && !isAnyPieceOnTheWay(from_i,from_j,to_i,to_j))
                {
