...
public class Game {
    ...
    public boolean isAnyPieceOnTheWay(int from_i, int from_j, int to_i, int to_j) {
        ...
        if (max_delta>1)
        {
            Report.report(" max Delta : "+ max_delta);
            Report.report(" delta_i : "+ delta_i);
            Report.report(" delta_j : "+ delta_j);
    ...
    public boolean isValidMove(int from_i, int from_j, int to_i, int to_j) {
        ...
        if (board.getPieceOnTheSpot(from_i,from_j).isValidMove(board,to_i,to_j)==false || isAnyPieceOnTheWay(from_i, from_j, to_i, to_j))
            return false;
    ...
    public boolean isValidRemove(int from_i, int from_j, int to_i, int to_j) {
        ...
        if (board.getPieceOnTheSpot(from_i,from_j).isValidRemove(board,to_i,to_j)==false || isAnyPieceOnTheWay(from_i, from_j, to_i, to_j))
            return false;
